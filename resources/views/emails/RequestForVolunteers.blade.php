...
<div>
  ...
  <p>{{ $concept->content }}</p>
    ...
    @elseif ($concept->layer === 3)
    <p>投票できるものがありませんでしたか？その時は貴方がこのアイデアを実現しうると思う理想の”プロジェクト”を登録してください！</p>
    @elseif ($concept->layer === 2)
    <p>投票できるものがありませんでしたか？その時は貴方がこのニーズを満たしうると思う理想の”アイデア”を登録してください！</p>
    @elseif ($concept->layer === 1)
    <p>投票できるものがありませんでしたか？その時は貴方がこのストレスを解決する方向性として理想の”ニーズ”を登録してください！</p>
    @endif
    @if ($concept->layer !== 5)
